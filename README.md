...
<p align="center">
  ...
  <a href="https://github.com/matthews-wong/claude-code-plugins"><img alt="Plugins" src="https://img.shields.io/badge/Claude%20Code-61%20plugins-D97757?logo=anthropic&logoColor=white"></a>
...
A marketplace of **61 Claude Code plugins** — agentic-workflow core (skills, subagents, verification hooks, orchestration, cost controls) organized around Boris Cherny's five stages of AI adoption, plus an enterprise layer for security, compliance, governance, and quality, and plugins modeled on his own workflow. Includes research docs on writing good plugins, lean/structured context, and the Boris Cherny playbook. `/plugin marketplace add matthews-wong/claude-code-plugins`
